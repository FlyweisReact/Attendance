  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://nxyf2bcbj9.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/scs/${id}`,
        {
          headers: {
            Authorization: `Bearer ${AdminToken}`,
          },
    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">Add SC's</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Container>
