  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://nxyf2bcbj9.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/phcs/${id}`,
        {
          headers: {
            Authorization: `Bearer ${AdminToken}`,
          },
    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">Add PHC's</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Container>
