    ...
    const AddEmployee = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://nxyf2bcbj9.execute-api.ap-south-1.amazonaws.com/dev/api/v1/emp/add" , formD
        );
        console.log(data)
          ...
          <Container>
            <Form onSubmit={AddEmployee}>
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" required onChange={(e) => setEmployeeName(e.target.valueAsNumber)}/>
              </Form.Group>
