    ...
    <>
      ...
      >
        <div style={{width : '100%' , display : 'flex' , justifyContent : 'space-between'}}>
          <span style={{ color: "black", fontSize: "15px", fontWeight: "400"  , width : '10%'}}>
            All Employee's (Total : {data.length})
            <hr style={{ width: "70%" }} />
          </span>
          <div style={{ display: "flex", gap: "10px" , width : '0%' }}>
        ...
        {/* Table */}
        <div style={{ overflow: "auto",  width : '80%' , maxWidth : '100%' , marginLeft : '5%' , marginTop : '2%'}}>
