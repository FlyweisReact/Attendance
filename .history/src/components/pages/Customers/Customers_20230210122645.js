          ...
          <Container>
            <Form onSubmit={AddEmployee}>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control type="text" required   onChange={(e) => setEmployeeName(e.target.value)} />
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  <option>--Select Role--</option>
                  {employeeRole?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.role}>{i.role} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EofficeLocation?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.officeLocation}>{i.officeLocation} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EfetchDepartment?.data?.map((i, index) => (
                    <>
                      <option key={index}  value={i.department}>{i.department} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EfetchTaluka?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.taluka}>{i.taluka} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EfetchPHC?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.PHC}>{i.PHC} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EfetchSC?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.SC}>{i.SC} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label="Default select example" required   onChange={(e) => setEmployeeName(e.target.value)}>
                  ...
                  {EfetchMedicalOffice?.data?.map((i, index) => (
                    <>
                      <option key={index} value={i.medicalOfficer}>{i.medicalOfficer} </option>
                    </>
                  ))}
                </Form.Select>
              </Form.Group>
